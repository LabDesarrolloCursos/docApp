...
import es.lab.docapp.config.audit.AuditEventConverter;
import es.lab.docapp.domain.PersistentAuditEvent;
import es.lab.docapp.repository.PersistenceAuditEventRepository;
import es.lab.docapp.security.AuthoritiesConstants;

import es.lab.docapp.service.AuditEventService;
