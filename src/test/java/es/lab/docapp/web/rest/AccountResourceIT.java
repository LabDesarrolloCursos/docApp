...
import es.lab.docapp.config.Constants;
import es.lab.docapp.domain.Authority;
import es.lab.docapp.domain.User;
import es.lab.docapp.repository.AuthorityRepository;
import es.lab.docapp.repository.UserRepository;
import es.lab.docapp.security.AuthoritiesConstants;
import es.lab.docapp.service.UserService;
import es.lab.docapp.service.dto.PasswordChangeDTO;
import es.lab.docapp.service.dto.UserDTO;
import es.lab.docapp.web.rest.vm.KeyAndPasswordVM;
import es.lab.docapp.web.rest.vm.ManagedUserVM;
...
import static es.lab.docapp.web.rest.AccountResourceIT.TEST_USER_LOGIN;
